...
const CHEATS = [
  ...
  { when: 'つみたてNISA・iDeCoを口座振替で積み立てた', drText: 'NISA口座／iDeCo', crText: '普通預金', dr: 'iDeCo', cr: '普通預金' },
  { when: 'iDeCoが給与から天引きされた', drText: 'iDeCo', crText: '給与収入', dr: 'iDeCo', cr: '給与収入' },
  { when: '投資の評価額が変わった（月末）', drText: '「残高合わせ」を使います', crText: '評価損益', dr: 'iDeCo', cr: '評価損益' },
